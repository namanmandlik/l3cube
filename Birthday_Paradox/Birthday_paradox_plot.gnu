...
# set terminal png nocrop font "/usr/share/fonts/truetype/liberation/LiberationSans-Regular.ttf,12" fontscale 1.0 size 640,480 
# set output 'Deviation_Birthday_Paradox.png'
unset clip points
set clip one
unset clip two
...
set title "Birthday Paradox Problem" 
...
set xlabel "No of Persons" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Probability of atleast one shared birthday" 
...
GNUTERM = "wxt"
plot "Data.csv" using 1:2 with linesp title "25 Trials", "" using 1:3 with linesp title "100 Trials", "" using 1:4 with linesp title "1000 Trials" lt rgb "magenta", "" using 1:5 with linesp title "Theoritical" lt rgb "cyan"
#    EOF
